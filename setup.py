...
modules = [
    ...
    'pyfr.solvers.eqeuler',
    'pyfr.solvers.eqeuler.kernels',
    'pyfr.solvers.eqeuler.kernels.bcs',
    'pyfr.solvers.eqeuler.kernels.rsolvers',
    'pyfr.solvers.eqnavstokes',
    'pyfr.solvers.eqnavstokes.kernels',
    'pyfr.solvers.eqnavstokes.kernels.bcs',
    'pyfr.solvers.base',
...
package_data = {
    ...
    'pyfr.solvers.eqeuler.kernels': ['*.mako'],
    'pyfr.solvers.eqeuler.kernels.bcs': ['*.mako'],
    'pyfr.solvers.eqeuler.kernels.rsolvers': ['*.mako'],
    'pyfr.solvers.eqnavstokes.kernels': ['*.mako'],
    'pyfr.solvers.eqnavstokes.kernels.bcs': ['*.mako'],
